...
const style={
  ...
  garyText:`text-gray-400`,
  mainContainer:`space-y-4 rounded-b-lg py-4 dark:bg-[#313339]`,
    ...
    <div className={style.wrapper}>
      <div className={style.header}>
        <div className={style.headerContent}>
          <AiOutlineClockCircle className={`${style.grayText} ${style.headerIcon}`}/>
           <div className={style.grayText}>
          Sales Ends Dec 1 ,2022 at 12.00pm
        </div>
           </div>
        ...
        <div className={style.mainContainer}>
          <div className={style.priceInfoContainer}>
            <div className={`${style.grayText} ${style.mediumFont}`}>Buy at
            </div>
